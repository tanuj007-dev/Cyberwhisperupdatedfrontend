...
const MagicBento = ({
    ...
    const gridItems = items || cardData;
    const isDark = theme === 'dark';

    // Theme-dependent colors
    const bgMain = isDark ? '#060010' : '#ffffff';
    const textColor = isDark ? 'hsl(0, 0%, 100%)' : 'hsl(220, 15%, 10%)';
    const borderColor = isDark ? '#392e4e' : '#e5e7eb'; // gray-200
    const cardShadow = isDark ? 'rgba(0,0,0,0.15)' : 'rgba(0,0,0,0.05)';
