    ...
    return (
        <section id="skill-levels" className="relative w-full bg-white dark:bg-black py-24 px-6 overflow-hidden font-sans transition-colors duration-300">
            ...
            <div className="relative z-10 max-w-7xl mx-auto flex flex-col lg:flex-row items-center lg:items-start gap-16">
                ...
                <div className="w-full lg:w-[30%] pt-12 text-center lg:text-left h-fit flex flex-col items-center lg:items-start text-balance">
                    <motion.div
                    ...
                    >
                        <div className="inline-flex items-center justify-center lg:justify-start">
                            <div className="w-16 h-16 flex items-center justify-center">
                                <Award className="w-12 h-12 text-[#6B46E5] dark:text-[#c084fc]" />
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <div className="relative h-full w-full rounded-[calc(2.5rem-2px)] bg-[#F5F3FF]/95 backdrop-blur-xl dark:bg-[#0f0720] dark:bg-none overflow-hidden transition-colors duration-300">
                                ...
                                <div className="relative z-10 flex flex-col h-full p-8 md:p-10">
                                    ...
                                    <p className="text-[#1a1a2e] dark:text-gray-400 text-[15px] leading-relaxed font-semibold mb-8">
                                        {card.description}
                                    </p>
