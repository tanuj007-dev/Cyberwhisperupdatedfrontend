    ...
    <section className="relative pt-24 pb-12 md:pt-40 md:pb-24 overflow-hidden bg-[#170938]">
      ...
      <div className="w-full max-w-7xl mx-auto px-4 relative z-20 text-center">
        ...
        >
          ...
          <div className="relative px-4 py-1.5 md:px-6 md:py-2 rounded-full bg-[#030014] backdrop-blur-md text-primary text-[10px] md:text-xs font-bold uppercase tracking-[0.2em]">
        ...
        <motion.h1
          ...
          className="text-4xl sm:text-5xl md:text-8xl font-black text-white mb-4 md:mb-8 tracking-tighter"
        >
        ...
        <motion.div
          ...
          className="flex items-center justify-center gap-4 text-gray-400 font-medium text-sm md:text-base"
        >
