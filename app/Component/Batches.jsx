...
export default function Batches() {
    return (
        <section className="relative w-full py-12 md:py-24 bg-[#FBF9FF] overflow-hidden font-sans">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
                ...
                <div className="text-center mb-10 md:mb-16 space-y-3 md:space-y-4">
                    ...
                    <p className="text-gray-500 max-w-2xl mx-auto text-base md:text-lg leading-relaxed px-2">
                ...
                <motion.div
                    ...
                    className="bg-white rounded-[1.5rem] shadow-[0_10px_40px_rgba(107,70,229,0.1)] overflow-hidden border border-gray-100"
                >
                    ...
                    <div>
                        {batches.map((batch, index) => (
                            <motion.div
                                ...
                                key={index}
                                className={`p-6 md:px-8 md:py-4 grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-4 items-start md:items-center border-b border-gray-50 hover:bg-purple-50/40 transition-colors ${index % 2 !== 0 ? 'bg-[#FAFAFA]' : 'bg-white'}`}
                            >
                                {/* Course Name */}
                                <div className="md:col-span-4 md:ml-8 flex flex-col items-center md:items-start text-center md:text-left">
                                    <h3 className="text-[#1a1a2e] font-semibold text-lg md:text-[16px] mb-1">{batch.title}</h3>
                                    <span className="text-gray-400 text-sm md:text-[13px] font-medium tracking-wide">Professional Certification</span>
                                </div>
                                ...
                                <div className="md:col-span-5 grid grid-cols-2 md:grid-cols-5 gap-4 w-full md:w-auto mt-2 md:mt-0">
                                    ...
                                    <div className="md:col-span-2 flex flex-col md:flex-row items-center justify-center gap-1 md:gap-0">
                                        ...
                                        <span className="text-[#1a1a2e] font-semibold text-base md:text-[16px]">{batch.date}</span>
                                    </div>

                                    {/* Timing */}
                                    <div className="md:col-span-3 flex flex-col items-center justify-center">
                                        <span className="md:hidden text-xs text-gray-400 font-bold uppercase tracking-wider mb-1">Time</span>
                                        <div className="text-[#1a1a2e] font-semibold text-base md:text-[16px] mb-0.5">{batch.time}</div>
                                        <span className="text-gray-400 text-xs md:text-[12px] font-medium">Flexible Schedule</span>
                                    </div>
                                </div>
                                ...
                                <div className="md:col-span-3 flex justify-center md:justify-end md:pr-8 w-full md:w-auto mt-4 md:mt-0">
                                    <button className="w-full md:w-auto bg-[#26103A] text-white px-6 py-3 md:py-2.5 rounded-full text-sm font-semibold hover:bg-[#7B3FE4] transition-all duration-300 hover:shadow-lg active:scale-95 flex items-center justify-center gap-2 group">
