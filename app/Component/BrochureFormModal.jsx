...
export default function BrochureFormModal({ open, onClose, brochureUrl, courseTitle, courseId }) {
    useEffect(() => {
        if (!open) return
        ...
        >
            ...
            <div className="relative w-full max-w-md bg-card dark:bg-gray-900 rounded-2xl shadow-xl border border-[#7B2CFF]/30 overflow-hidden">
                ...
                <div className="p-6 pt-10">
                    <BrochureForm className="p-0! border-0! shadow-none!" onSuccess={onClose} brochureUrl={brochureUrl} courseTitle={courseTitle} courseId={courseId} />
                </div>
            </div>
        </div>
    )
