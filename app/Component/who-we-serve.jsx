...
export default function WeServe() {
  return (
    <section className="relative overflow-hidden bg-[#FBFAFF] py-24 lg:py-32 font-sans">
            ...
            >
              ...
              <div className="relative w-full h-full rounded-[3rem] overflow-hidden border border-white/10 shadow-[0_0_50px_rgba(79,183,193,0.15)] group">
                ...
                <motion.div
                  ...
                  className="absolute left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#4FB7C1]/50 to-transparent z-20 pointer-events-none"
                />
              </div>
            </motion.div>
          </div>
          ...
          <div className="lg:col-span-6">
            ...
            >
              <div className="space-y-6">
                ...
                {/* Heading */}
                <h2 className="text-4xl lg:text-[45px] font-bold leading-[1.2] text-[#030014] tracking-tight">
                ...
                {/* Description */}
                <p className="text-[17px] leading-relaxed text-slate-500 font-medium max-w-xl">
                ...
                {/* Badge/Feature */}
                <div className="inline-flex items-center gap-2 bg-[#6B46E5] text-white px-5 py-2 rounded-md font-semibold text-sm transition-transform hover:scale-105 cursor-default">
                ...
                <div className="flex flex-wrap gap-5 pt-8">
                  <button className="bg-[#1D0B2E] hover:bg-[#2A1042] text-white px-10 py-4 rounded-full font-bold text-[15px] transition-all duration-300 shadow-xl shadow-[#1D0B2E]/20 active:scale-95">
                    Learn More
                  </button>
                  <button className="border-2 border-[#1D0B2E]/10 hover:border-[#1D0B2E] text-[#1D0B2E] px-10 py-4 rounded-full font-bold text-[15px] transition-all duration-300 active:scale-95">
                    Contact Us
                  </button>
                </div>
              </div>
