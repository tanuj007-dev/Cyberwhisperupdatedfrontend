...
const FeatureCard = ({ title, description, align = 'left' }) => (
    <div className={`w-full md:max-w-[320px] ${align === 'right' ? 'text-center md:text-right' : align === 'left' ? 'text-center md:text-left' : 'text-center'} pointer-events-auto bg-white/50 dark:bg-transparent backdrop-blur-sm p-4 rounded-xl md:bg-transparent md:p-0`}>
