...
export default function TestimonialsSection() {
  ...
  return (
    <section className="py-20 bg-[#6B46E5] overflow-hidden font-sans">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <motion.h2
            ...
            className="text-4xl md:text-[50px] font-semibold text-white tracking-tight"
          >
        ...
        >
          ...
          <div className="absolute top-1/2 -left-4 -right-4 md:-left-12 md:-right-12 -translate-y-1/2 flex justify-between pointer-events-none z-20">
            <button
              onClick={prevSlide}
              className="w-12 h-12 rounded-full border border-white/20 bg-white/10 flex items-center justify-center text-white hover:bg-white hover:text-[#6B46E5] transition-all duration-300 pointer-events-auto backdrop-blur-md group shadow-xl"
                ...
                return (
                  ...
                  >
                    <motion.div
                      ...
                      className="relative rounded-3xl bg-white/10 border border-white/20 p-8 h-full flex flex-col justify-between backdrop-blur-md transition-all duration-500 hover:bg-white/[0.15] group shadow-2xl"
                    >
                      {/* Top Row: Stars & Quote */}
                      <div className="flex justify-between items-start mb-6">
                        <div className="flex gap-1">
                          {[...Array(5)].map((_, s) => (
                            <svg key={s} className="w-4 h-4 text-yellow-400 drop-shadow-[0_0_8px_rgba(250,204,21,0.5)]" fill="currentColor" viewBox="0 0 20 20">
                              <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                            </svg>
                          ))}
                        </div>
                        <div className="text-white/20 group-hover:text-white/40 transition-colors duration-500">
                      ...
                      {/* Content */}
                      <div className="grow">
                        <p className="text-[15px] leading-relaxed text-white/90 font-medium italic mb-6">
                          {testimonial.text}
                        </p>
                      </div>
                      ...
                      <div className="flex items-center gap-4">
                        <div className="relative">
                          ...
                          <img
                            ...
                            className="relative w-14 h-14 rounded-full object-cover border-2 border-white/60 shadow-lg"
                          />
                        </div>
                        <div>
