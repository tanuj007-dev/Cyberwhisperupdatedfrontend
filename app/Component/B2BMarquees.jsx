...
export default function B2BMarquees() {
    ...
    const MarqueeItem = ({ text }) => (
        <div className="group relative inline-flex items-center gap-1.5 md:gap-2.5 px-3 py-1.5 md:px-5 md:py-2.5 bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-900/80 dark:to-gray-800/60 border border-gray-300/70 dark:border-purple-500/30 rounded-full backdrop-blur-md whitespace-nowrap shadow-sm hover:shadow-lg hover:shadow-purple-500/20 dark:hover:shadow-purple-500/40 transition-all duration-300 hover:scale-105 hover:border-purple-400 dark:hover:border-purple-400">
            ...
            <span className="relative text-xs md:text-sm font-bold bg-gradient-to-r from-gray-800 to-gray-900 dark:from-gray-100 dark:to-gray-300 bg-clip-text text-transparent group-hover:from-purple-600 group-hover:to-purple-800 dark:group-hover:from-purple-300 dark:group-hover:to-purple-100 transition-all duration-300">
                {text}
            </span>
        </div>
    );
    ...
    const MarqueeRow = ({ items, duration, reverse, label }) => {
        ...
        return (
            <div className="mb-4 md:mb-8">
                ...
                <div className="max-w-7xl mx-auto px-4 mb-2 md:mb-4">
                ...
                <div className="relative overflow-hidden py-2 md:py-4">
                    {/* Marquee content */}
                    <div className="flex gap-3 md:gap-6" style={animationStyle}>
                        {items.map((item, idx) => (
    ...
    return (
        <div className="relative w-full bg-gradient-to-b from-gray-50 via-gray-100/50 to-gray-50 dark:from-[#0a0015] dark:via-[#150833]/30 dark:to-[#0a0015] py-8 md:py-16 overflow-hidden">
