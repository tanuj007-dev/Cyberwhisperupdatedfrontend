        ...
        <main className="min-h-screen bg-[#030014] relative overflow-hidden">
            ...
            <div className="relative z-10">
                ...
                <motion.section
                    ...
                    className="py-24 border-y border-white/5 relative"
                >
                        ...
                        <div className="grid lg:grid-cols-2 gap-16 items-center">
                            <div className="space-y-8 text-white">
                                ...
                                >
                                    ...
                                    <h2 className="text-4xl md:text-[50px] font-semibold leading-tight">
                                ...
                                <div className="grid md:grid-cols-2 gap-6">
                                    <motion.div
                                        ...
                                        className="flex gap-4 p-6 glass-panel rounded-2xl border-white/5 hover:border-primary/20 transition-all group"
                                    >
                                        <div className="text-3xl font-bold text-primary group-hover:scale-110 transition-transform">25+</div>
                            ...
                            <motion.div
                                ...
                                className="relative"
                            >
                                <div className="relative rounded-2xl overflow-hidden border border-white/10 grayscale hover:grayscale-0 transition-all duration-700 shadow-2xl aspect-square">
                                    <Image
                                        src="/cyber_security_expert_analysis_1767456147793.png"
                                        alt="Expert Analysis"
                                        fill
                                ...
                                {/* Floating badge */}
                                <div className="absolute -top-6 -right-6 w-32 h-32 rounded-full bg-primary flex flex-col items-center justify-center text-white text-center shadow-[0_0_30px_rgba(168,85,247,0.5)] animate-bounce-slow z-20">
