                        ...
                        <div className="grid lg:grid-cols-2 gap-16 items-center">
                            <div className="space-y-8 text-white">
                                ...
                                >
                                    ...
                                    <h2 className="text-2xl sm:text-3xl md:text-[50px] font-semibold leading-tight">
                                ...
                                <div className="grid grid-cols-2 gap-3 md:gap-6">
                                    <motion.div
                                        ...
                                        className="flex flex-col md:flex-row items-center md:items-start text-center md:text-left gap-2 md:gap-4 p-4 md:p-6 glass-panel rounded-2xl border-white/5 hover:border-primary/20 transition-all group"
                                    >
