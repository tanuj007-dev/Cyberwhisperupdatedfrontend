...
async function testBlogsAPI() {
    try {
        ...
        const response = await fetch('https://darkred-mouse-801836.hostingersite.com/api/blogs', {
            method: 'POST',
            headers: {
        ...
        console.log('\n⚠️  Make sure your Next.js dev server is running on https://darkred-mouse-801836.hostingersite.com');
...
async function testGetBlogs() {
    try {
        ...
        const response = await fetch('https://darkred-mouse-801836.hostingersite.com/api/blogs?limit=5&page=1');
        const data = await response.json();
